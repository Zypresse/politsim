...
class Bulbostan extends ConstitutionTemplate
{
    ...
    public static function generate(State &$state, $params = [])
    {
        ...
        $state->constitution->setArticleByType(ConstitutionArticleType::PARTIES, null, Parties::NEED_CONFIRM, null, 10000);
        $state->constitution->setArticleByType(ConstitutionArticleType::MULTIMEMBERSHIP, null, false);
