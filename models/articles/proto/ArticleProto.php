...
namespace app\models\articles\proto;

use app\components\MyModel;

/**
 * Тип пункта конституции. Таблица "articles_prototypes".
 *
 * @property integer $id
 ...
 */
class ArticleProto extends MyModel {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'articles_prototypes';
    }
     ...
     * @param \app\models\articles\Article $value
     */
