...
abstract class TileCombiner
{
    ...
    const MAX_TILES_COUNT = 100000;

    protected static function pointToInt($point)
    {
        return [(int) ($point[0] * Tile::LAT_LON_FACTOR), (int) ($point[1] * Tile::LAT_LON_FACTOR)];
    }

    protected static function pointToFloat($point)
    {
        return [$point[0] / Tile::LAT_LON_FACTOR, $point[1] / Tile::LAT_LON_FACTOR];
    }
    ...
    public static function combineList(array $list)
    {
        ...
        if ($count == 0) {
            return [];
        } elseif ($count > static::MAX_TILES_COUNT) {
