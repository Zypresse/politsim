...
if(typeof(markerConfig.image) != 'undefined'){
  ...
  getMarkerPosition: function(markerConfig) {
    if (jvm.WorldMap.maps[this.params.map].projection) {
      ...
      return {
        x: markerConfig.latLng[0]*this.scale + this.transX*this.scale,
        y: markerConfig.latLng[1]*this.scale + this.transY*this.scale
      };
    }
  },
...
if (insets != undefined)        for (i = 0; i < insets.length; i++) {
      inset = insets[i];
      bbox = inset.bbox;
