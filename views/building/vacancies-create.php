...
<?php $form->begin([
    ...
    'action' => Url::to(['building/vacancy-create-form']),
    'enableClientValidation' => true,
    'enableAjaxValidation' => true,
    'validationUrl' => Url::to(['building/vacancy-create-form', 'id' => $building->id])
]) ?>
...
<script type="text/javascript">
    ...
    $form.on('submit', function() {
        if ($form.yiiActiveForm('data').validated) {
            json_request('building/vacancy-create', $form.serializeObject(), false, false, false, 'POST');
        }
        return false;
    });
