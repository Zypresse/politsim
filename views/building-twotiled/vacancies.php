...
<script type="text/javascript">
    ...
    $('#btn-add-vacancy').click(function(){
        createAjaxModal(
            'building-twotiled/vacancy-create-form',
            {id:<?=$building->id?>},
            ...
            'building-twotiled-vacancies-modal'
        );
    });
    
    $('.btn-delete-vacancy').click(function(){
        json_post_request('building-twotiled/vacancy-delete',{id:<?=$building->id?>,vacancyId:$(this).data('vacancyId')});
    });
    
    $('.btn-edit-vacancy').click(function(){
        createAjaxModal(
            'building-twotiled/vacancy-edit-form',
