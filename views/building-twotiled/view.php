        ...
        <div class="col-md-12">            
            <div class="box">
                <div class="box-header">
                    <h1>
                        <?=Html::encode($building->name)?>
                         <small>(<?=Html::encode($building->nameShort)?>)</small>
                    </h1>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if ($building->tile && $building->tile2): ?>
                            <p>
                                <strong><?=Yii::t('app', 'Location:')?></strong>
                                <?= $building->city ? LinkCreator::cityLink($building->city) : LinkCreator::regionLink($building->region) ?>
                                —
                                <?= $building->city2 ? LinkCreator::cityLink($building->city2) : LinkCreator::regionLink($building->region2) ?>
                            </p>
                            <?php endif ?>
                            <p>
