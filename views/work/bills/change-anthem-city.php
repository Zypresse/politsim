...
<?php $form->begin([
    ...
    'validationUrl' => Url::to(['work/new-bill-form', 'postId' => $post->id, 'protoId' => BillProto::CHANGE_ANTHEM_CITY])
]) ?>
...
<?=$form->field($model, 'dataArray[anthem]')->textInput()->label(Yii::t('app', 'City anthem'))?>
