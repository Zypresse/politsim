...
<?php $form->begin([
    ...
    'validationUrl' => Url::to(['work/new-bill-form', 'postId' => $post->id, 'protoId' => BillProto::CHANGE_FLAG_CITY])
]) ?>
...
<?=$form->field($model, 'dataArray[flag]')->textInput()->label(Yii::t('app', 'City flag'))?>
