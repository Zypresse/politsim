...
<?php $form->begin([
    ...
    'validationUrl' => Url::to(['work/new-bill-form', 'postId' => $post->id, 'protoId' => BillProto::RENAME_CITY])
]) ?>
...
<?=$form->field($model, 'dataArray[name]')->textInput()->label(Yii::t('app', 'City name'))?>
<?=$form->field($model, 'dataArray[nameShort]')->textInput()->label(Yii::t('app', 'City short name'))?>
