...
<?php $form->begin([
    ...
    'validationUrl' => Url::to(['work/new-bill-form', 'postId' => $post->id, 'protoId' => $model->protoId])
]) ?>
...
<?=$this->render(BillProto::getViewByType($model->protoId), [
    'form' => $form,
    'model' => $model,
    'post' => $post,
])?>
...
<?=$this->render(BillProto::getViewByType($model->protoId).'_js')?>