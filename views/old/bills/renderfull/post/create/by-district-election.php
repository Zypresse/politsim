...
<p>
    <strong><?=Yii::t('app', 'Destignation type')?>:</strong> <?=Yii::t('app', 'By electoral district election')?><br>
    <strong><?=Yii::t('app', 'Electoral district')?>:</strong> <?=Html::encode($district->name)?><br>
