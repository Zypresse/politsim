...
<?php $form->begin([
    ...
    'action' => Url::to(['unit/vacancy-create-form']),
    'enableClientValidation' => true,
    'enableAjaxValidation' => true,
    'validationUrl' => Url::to(['unit/vacancy-create-form', 'id' => $building->id])
]) ?>
...
<script type="text/javascript">
    ...
    $form.on('submit', function() {
        if ($form.yiiActiveForm('data').validated) {
            json_request('unit/vacancy-create', $form.serializeObject(), false, false, false, 'POST');
        }
        return false;
    });
