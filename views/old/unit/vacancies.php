...
<div class="help-block text-light-blue">
    <p><i class="fa fa-exclamation-triangle"></i> <?= Yii::t('app', 'Firm needs next workers:') ?></p>
    <ul>
...
<script type="text/javascript">
    ...
    $('#btn-add-vacancy').click(function(){
        createAjaxModal(
            ...
            'unit-vacancies-modal'
        );
    });
    
    $('.btn-delete-vacancy').click(function(){
        json_post_request('unit/vacancy-delete',{id:<?=$building->id?>,vacancyId:$(this).data('vacancyId')});
    });
    
    $('.btn-edit-vacancy').click(function(){
        createAjaxModal(
            'unit/vacancy-edit-form',
