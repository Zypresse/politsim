...
<td><? if ($player->party) { ?><a href="#" onclick="load_page('party-info',{'id':<?=$player->party_id?>})"><?=htmlspecialchars($player->party->short_name)?></a><? } else { echo ($player->sex == 1) ? 'Беспартийная' : 'Беспартийный'; } ?></td>
<td>
