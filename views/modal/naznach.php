...
<td><? if ($player->party_id) { ?><a href="#" onclick="load_page('party_info',{'id':<?=$player->party_id?>})"><?=htmlspecialchars($player->party->name)?></a><? } else { echo ($player->sex == 1) ? 'Беспартийная' : 'Беспартийный'; } ?></td>
<td>
