<? switch ($gft->type) {
    case "checkbox":
        ?>
        <input <?=($gfv->value)?'checked="checked"':''?> type="checkbox" class="bill_field" id="bill7_goverment_field_value" name="goverment_field_value">
        <?
    ...
    case "number":
        ?>
        <input value="<?=$gfv->value?>" type="number" class="bill_field" id="bill7_goverment_field_value" name="goverment_field_value">
        <? break;
    case "org_dest_members":
        ?>
        <select class="bill_field" id="bill7_goverment_field_value" name="goverment_field_value">
...
<!--            <option <?=($gfv->value=="dest_by_stateleader")?'selected="selected"':''?> value="dest_by_stateleader">Назначаются главой государства</option>-->
        ...
        <? break;
    default: ?>
        <input value="<?=$gfv->value?>" type="text" class="bill_field" id="bill7_goverment_field_value" name="goverment_field_value">
        <? break;
} ?>