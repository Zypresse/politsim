...
/* @var $agencyDestignator app\models\politics\Agency */
/* @var $settings string[] */
...
<p>
    <strong><?=Yii::t('app', 'Destignation type')?>:</strong> <?=Yii::t('app', 'By agency election')?><br>
    <strong><?=Yii::t('app', 'Agency')?>:</strong> <?=LinkCreator::agencyLink($agencyDestignator)?><br>
